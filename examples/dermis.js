...
"string"&&!b[l].match(/(\#|\.)/))b[l]+="#set";H(b);if(!e)for(b=0;b<v.length;++b)y(v[b][1],b)}};d.routes.dispatcher=function(b,e){b(e)};d.routes.history=[];var ba=false,R=false,v=[],T=[],Y=false,U=false})(jQuery,this);// Generated by CoffeeScript 1.3.1
(function() {
  ...
  define("dermis", ["jade"], function(jade) {
    ...
    route = function(url, service, view) {
      ...
      route = {};
      route[url] = function(a) {
        return require([service, view], function(s, t) {
          return s(a, t);
        });
      };
      return $.routes(route);
